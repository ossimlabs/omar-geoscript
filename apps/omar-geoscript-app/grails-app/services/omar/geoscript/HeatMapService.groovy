...
class HeatMapService {
    ...
    Layer getLayer(WmsRequest wmsRequest, String req)
    {
        ...
        URL url = new URL(req);
        String x = """{"from":0, "size":6000, "query":{"bool": { "must": [ { "term": {"requestMethod": "GetMap"}}, {"range":{"@timestamp":{"gte": "${wmsRequest.start_date}","lte":"${wmsRequest.end_date}"}}}]}}, "sort": {"@timestamp": { "order": "desc"}}}"""
